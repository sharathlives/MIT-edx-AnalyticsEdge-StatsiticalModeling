...
plot(WHO$GNI, WHO$FertilityRate) #uses the base plotting system
...
scatterplot = ggplot(WHO, aes(x = GNI, y = FertilityRate)) #aesthetic mapping defines what variables to plot in X and Y axis

# Add the geom_point geometry
scatterplot + geom_point() #geometry we add is points

# Make a line graph instead:
scatterplot + geom_line() #geometry we add is lines
...
pdf("MyPlot.pdf") #creates pdf file in the wroking directory

print(fertilityGNIplot)

dev.off() #switch off device
