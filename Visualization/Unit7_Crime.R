...
# Create our plot
ggplot(WeekdayCounts, aes(x=Var1, y=Freq)) + geom_line(aes(group=1))  #group = 1, groups all the data into 1 line since we need just 1 line in our plot
...
#Change the line type and make the line lighter
...
# Change the label on the legend, and get rid of the y-label. To get rid of the y-label you can also do ylab = ""
