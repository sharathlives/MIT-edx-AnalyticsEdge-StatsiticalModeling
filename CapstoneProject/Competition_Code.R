...
HeadlineWordsTest$Month = factor(NewsTest$Month, levels = levels(HeadlineWordsTrain$Month)) 
HeadlineWordsTest$Year = factor(NewsTest$Year, levels = levels(HeadlineWordsTrain$Year)) 
...
HeadlineWordsTest$SectionName <- factor(NewsTest$SectionName, levels = levels(HeadlineWordsTrain$SectionNam))
...
PredictTrain = predict(HeadlineWordsLog, newdata = HeadlineWordsTrain, type = "response")
